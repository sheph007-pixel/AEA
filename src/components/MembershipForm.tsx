  ...
  if (status === 'sent') {
    return (
      <div className="bg-accent-50 border border-accent-200 rounded-xl p-8 text-center">
        <h3 className="text-lg font-semibold text-navy-900 mb-2">Inquiry received</h3>
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-5">
      <div className="grid sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="mem-firstName" className="block text-sm font-medium text-gray-700 mb-1.5">
            First name
          </label>
          <input
            type="text"
        ...
        <div>
          <label htmlFor="mem-lastName" className="block text-sm font-medium text-gray-700 mb-1.5">
            Last name
          </label>
          <input
            type="text"
      ...
      <div>
        <label htmlFor="mem-email" className="block text-sm font-medium text-gray-700 mb-1.5">
          Email
        </label>
        <input
          type="email"
      ...
      <div>
        <label htmlFor="mem-company" className="block text-sm font-medium text-gray-700 mb-1.5">
          Organization name
        </label>
        <input
          type="text"
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        <div>
          <label htmlFor="mem-employees" className="block text-sm font-medium text-gray-700 mb-1.5">
            Number of employees
          </label>
          <select
            id="mem-employees"
        ...
        <div>
          <label htmlFor="mem-industry" className="block text-sm font-medium text-gray-700 mb-1.5">
            Industry
          </label>
          <input
            type="text"
      ...
      <div>
        <label htmlFor="mem-message" className="block text-sm font-medium text-gray-700 mb-1.5">
