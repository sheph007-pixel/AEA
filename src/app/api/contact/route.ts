...
export async function POST(request: Request) {
  ...
  try {
    ...
    await resend.emails.send({
      ...
      subject: `AEA Contact Form: ${firstName} ${lastName} - ${interest || 'General Inquiry'}`,
      html: `
        ...
        <table style="border-collapse:collapse;width:100%;max-width:600px;">
          ...
          <tr><td style="padding:8px;font-weight:bold;border-bottom:1px solid #eee;">Interest</td><td style="padding:8px;border-bottom:1px solid #eee;">${interest || 'Not specified'}</td></tr>
