---
title: "Compliance Alert: 2026 State Minimum Wage Updates"
description: "An overview of state and local minimum wage increases taking effect in 2026 and the steps employers should take to ensure compliance."
...
**Multi-state operations:** Employers with operations or remote workers in multiple states face particular complexity. The applicable rate is generally determined by the location where the employee performs the work, not the location of the employer's headquarters. Remote employees working from home in a jurisdiction with a higher minimum wage may need to be paid at that jurisdiction's rate. Employers should verify the rules in each applicable jurisdiction.
...
- Not adjusting overtime calculations, which generally must be based on the regular rate including the updated minimum wage.

## What Employers Should Do Now

1. Identify every state and locality where employees work, including remote workers.
2. Confirm the current 2026 minimum wage rate for each of those jurisdictions by consulting the relevant state labor department or agency.
3. Verify that payroll systems are updated and the first payroll of 2026 reflects the correct rates.
4. Update workplace posters and any digital notices provided to remote employees.
5. Review tipped employee pay practices where applicable.
6. Document the steps taken to ensure compliance as part of your audit trail.

Minimum wage compliance is one of the most fundamental obligations for employers, but the patchwork of state and local rates makes it an area where errors are common. Proactive review at the start of each year is generally the most effective way to reduce exposure. Employers should verify current rates with the applicable state and local agencies and consult qualified counsel with questions about specific obligations.
