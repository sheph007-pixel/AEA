---
title: "Monthly Employer Briefing: March 2026"
description: "March 2026 employer briefing covering spring hiring season, EEO-1 reporting, state legislative activity, workplace safety reviews, and Q2 planning priorities."
...
- **Reviewing job postings for legal compliance.** Pay transparency laws may now apply in a growing number of states and localities, potentially requiring disclosure of salary ranges in job postings. Employers posting positions that may attract applicants from multiple states — particularly remote roles — should ensure every posting complies with the broadest set of applicable requirements. Requirements vary by state, and employers should verify current rules.
...
- **Cannabis and employment.** As the legal landscape around cannabis continues to evolve, several states are considering employment-related bills addressing drug testing policies, off-duty use protections, and impairment standards.
