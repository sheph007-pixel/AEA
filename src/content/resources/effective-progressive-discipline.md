---
title: "Implementing Effective Progressive Discipline"
description: "How to design and apply a progressive discipline system that is fair, consistent, and legally defensible."
...
1. **Verbal counseling (documented)**: A conversation between the supervisor and employee identifying the problem, the expected standard, and the consequences of continued failure to meet it. Document the date, topic, and outcome even though it is a verbal step.

2. **Written warning**: A formal written document describing the problem, citing specific incidents, referencing any prior verbal counseling, stating the expected improvement, and establishing a timeline for review.
...
4. **Termination**: When prior steps have failed to produce improvement.
