...
verified: true
factCheckedAt: "2026-05-04T10:29:46.624Z"
---
...
2. Calculate the regular rate by dividing total straight-time compensation by total hours worked
3. Multiply the regular rate by 1.5 to get the overtime rate
4. Multiply the overtime rate by the number of overtime hours
...
2. Divide total earnings by total hours worked to find the weighted regular rate
3. Calculate overtime premium at half the weighted regular rate (since straight-time pay for those hours is already included)
...
1. Divide the bonus by the total hours worked during the bonus period
2. Add this per-hour amount to the regular rate for each week
3. Calculate the additional overtime owed for each week in which overtime was worked
