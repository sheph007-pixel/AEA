...
description: "How to properly handle wage garnishment orders, including child support, tax levies, and creditor garnishments, while complying with federal and state law."
category: "Operations"
date: "2018-06-14"
...
1. Child support orders generally take first priority
...
1. **Designate a single point of contact** for receiving and processing garnishment orders — typically someone in payroll.
2. **Respond promptly.** Begin withholding on the pay period specified in the order. If there is a deadline to file a response or answer with the court, meet it.
3. **Calculate correctly.** Use the right definition of disposable earnings and apply the correct limits.
4. **Remit on time.** Send the withheld amounts to the designated payee by the deadlines specified in the order.
5. **Notify the employee.** Inform the employee that you have received the order and will be making deductions from their pay.
6. **Maintain records.** Keep copies of all garnishment orders, calculations, and remittance records.
7. **Track terminations and changes.** If the employee leaves or is terminated, notify the issuing agency or court as required by the order.
