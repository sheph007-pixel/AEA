...
Employers may conduct drug testing in several situations:

- **Pre-employment testing**: After a conditional offer of employment, before the employee starts work
- **Reasonable suspicion testing**: When a supervisor has objective, articulable reasons to believe an employee is under the influence
- **Post-accident testing**: After a workplace accident, often limited to situations where impairment may have been a contributing factor
- **Random testing**: Unannounced testing of employees selected through a random process
- **Return-to-duty and follow-up testing**: After an employee returns from a substance abuse treatment program

Not all types of testing are permitted in all states. Some states restrict random testing to safety-sensitive positions or require specific conditions before testing is allowed.
...
State laws create a complex landscape for drug testing:

- Some states require employers to have a written drug testing policy before conducting any tests
- Several states limit testing to specific circumstances (such as reasonable suspicion or post-accident)
...
An effective drug testing policy should address:

- The purpose and scope of the program
- Which positions are subject to testing and what types of testing apply
- What substances are tested and what constitutes a positive result
- The consequences of a positive test, refusal to test, or adulteration of a sample
- Confidentiality protections for test results
- The employee's right to explain a positive result (prescription medications)
- EAP referral information
- Applicable state law requirements

## Marijuana in the Workplace

Marijuana legalization creates unique challenges for employers:
