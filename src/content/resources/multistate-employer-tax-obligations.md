---
title: "Navigating Tax Obligations as a Multistate Employer"
description: "Key tax considerations for employers with employees working in multiple states, including withholding, unemployment, and nexus issues."
category: "Operations"
date: "2016-12-08"
...
1. **Map your workforce.** Know exactly where every employee physically works, including remote workers. Update this information whenever an employee moves or changes work location.

2. **Register in each required state.** Obtain employer tax identification numbers, unemployment insurance accounts, and workers' compensation coverage in each state where you have obligations.

3. **Configure your payroll system correctly.** Your payroll provider needs accurate work-location data for each employee to apply the right withholding rules, tax rates, and wage bases.

4. **Monitor employee travel.** If employees travel to other states for work, track those days. Some employers use mobile timekeeping tools to record work location.

5. **Stay current on law changes.** State tax laws change frequently. Assign someone — or engage a payroll provider or tax advisor — to monitor developments in each state where you operate.
