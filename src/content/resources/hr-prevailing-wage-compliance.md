...
Workers must be classified according to the actual work they perform, not their job title. If a worker performs tasks falling under multiple classifications during a single workweek, they should generally be paid the highest applicable rate for each type of work performed. Misclassifying workers to pay lower rates is a common violation that can result in significant liability.
